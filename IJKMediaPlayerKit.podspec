...
TODO: Add long description of the pod here.
  ...
  s.ios.pod_target_xcconfig = {
    ...
    'HEADER_SEARCH_PATHS[sdk=iphoneos*]' => '$(inherited) ' \
      '${PODS_TARGET_SRCROOT}/ijkmedia ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/ffmpeg/include ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/dvdread/include ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/ass/include ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/bluray/include',
    ...
    'HEADER_SEARCH_PATHS[sdk=iphonesimulator*]' => '$(inherited) ' \
      ...
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/dvdread/include ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/ass/include ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/bluray/include',

    # 库文件搜索路径
    'LIBRARY_SEARCH_PATHS[sdk=iphoneos*]' => '$(inherited) ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/ass/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/uavs3d/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/dav1d/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/dvdread/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/ffmpeg/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/freetype/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/fribidi/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/harfbuzz/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/openssl/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/opus/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/unibreak/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/smb2/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/rubberband/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal/bluray/lib',

    'LIBRARY_SEARCH_PATHS[sdk=iphonesimulator*]' => '$(inherited) ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/ass/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/uavs3d/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/dav1d/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/dvdread/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/ffmpeg/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/freetype/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/fribidi/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/harfbuzz/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/openssl/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/opus/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/unibreak/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/smb2/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/rubberband/lib ' \
      '${PODS_TARGET_SRCROOT}/FFToolChain/build/product/ios/universal-simulator/bluray/lib',

    # 其他链接标志
    'OTHER_LDFLAGS' => '$(inherited) ' \
      '-l"opus" -l"crypto" -l"ssl" -l"dav1d" -l"dvdread" -l"freetype" ' \
      '-l"fribidi" -l"harfbuzz" -l"harfbuzz-subset" -l"unibreak" ' \
      '-l"ass" -l"uavs3d" -l"avcodec" -l"avdevice" -l"avfilter" ' \
      '-l"avformat" -l"avutil" -l"swresample" -l"swscale" ' \
      '-l"smb2" -l"bluray"',
  ...
  s.ios.frameworks = 'UIKit', 'OpenGLES', 'Accelerate'
  if ENV['sim'] == '1'
  ...
  s.library = 'z', 'iconv', 'xml2', 'bz2', 'lzma', 'stdc++'
